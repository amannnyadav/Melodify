...
import 'package:melodify/models/song.dart';
...
class PlaylistProvider extends ChangeNotifier {
  ...
  final List<Song> _playlist = [
    ...
    Song(
      ...
      artistName: "King",
      albumArtImagePath: "assets/images/Tu-Aake-Dekhle.jpeg",
      audioPath: "audio/Tu-Aake-Dekhle.mp3",
    ),
    ...
    Song(
      songName: "Ektarfa",
      artistName: "King",
      albumArtImagePath: "assets/images/ektarfa.jpg",
      audioPath: "audio/Ektarfa.mp3",
    ),
    ...
    Song(
      songName: "Legends",
      artistName: "King",
      albumArtImagePath: "assets/images/legends.jpg",
      audioPath: "audio/Legends.mp3",
    ),
  ];
